(function() {
      ...
      onExpire: function(key, value){
        getLeagueData()
          .then(function(){
            ...
            console.log("Error getting data from League. Putting expired item back in the cache", new Date());
    ...
    function getLeagueId(leagueId){
      ...
      console.log("currentLeagueId", id);
      return id;
    }
      ...
      if(leagueData){
        ...
        $http.get("http://elite-schedule.net/api/leaguedata/" + getLeagueId())
          .success(function(data, status){
            console.log("Received schedule leaguedata data via HTTP.", data, status);
            $ionicLoading.hide();
            deferred.resolve(data);
          })
          .error(function(){
